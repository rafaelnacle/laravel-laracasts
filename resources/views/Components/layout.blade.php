        ...
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <img class="h-12 w-12" src="/images/aliyah.png" alt="Your Company">
            </div>
              ...
              <div class="relative ml-3">
                <div>
                  <button type="button"
                    ...
                    <img class="h-8 w-8 rounded-full" src="/images/cyber.jpg" alt="">
                  </button>
                </div>
              </div>
            </div>
      ...
      <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            <div class="flex-shrink-0">
              <img class="h-10 w-10 rounded-full" src="/images/cyber.jpg" alt="">
            </div>
            <div class="ml-3">
              <div class="text-base font-medium leading-none text-white">Rafael</div>
              <div class="text-sm font-medium leading-none text-gray-400">rafael@example.com</div>
            </div>
            <button type="button"
